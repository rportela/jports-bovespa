...
@Up2DataTable(channel = "Equities", subChannel = "TradeInformation", prefix = "Equities_EODPriceFile_")
public class EquitiesEODPriceFile {
	 ...
	 * 
	 * <p>
	 * The Ticker Symbol is a short and convenient way of identifying a stock.
	 * </p>
	 */
	...
	public double traded_instrument_qty;
	...
	public double reg_traded_contracts;

	/**
	 * Non regular traded contracts.
	 */
	@Up2DataColumn(name = "NonRglrTraddCtrcts")
	public double nonreg_traded_contracts;
